...
1. [Arm fighter](https://github.com/ArmFightHelper/ArmFightFlutterApp/tree/develop) - app for arm fighting training and competitions
2. [Mood Tracker](https://github.com/CMDF-team-project/Project) - application that helps users to record and monitor their moods daily
3. [Flanner](https://github.com/Woolfer0097/FlannerOrganization) - fitness app designed to help you seamlessly track and improve your physical health
4. [Allergy](https://github.com/lime-based-lemonade/allergy-scanner) - app to scan barcodes on food items and see if they contains certain allergen
5. [Killer](https://github.com/cool-guys-flutter/killer_game_app) - app for playing a killer game
6. [DishDash](https://github.com/Linch-mini/DishDash) - app to suggest random ideas for what to eat and drink 
7. [FitTrack](https://github.com/1000-MLN/FitTrack) - app to help users create, edit, and track their workouts
8. [BreathApp](https://github.com/meldilen/DeepBreatheAPP/tree/dep) - app to help users practice breathing exercises
...
16. [NabitHelper](https://github.com/Habit-Helper-Team/Habit-Helper) - app to track habits
...
[Video to YouTube](https://youtu.be/euX7Q4NY-XE)

### YouTube playlist of lectures recording

[Link to playlist](https://youtube.com/playlist?list=PLz1kbB-Ej5hV5qu-9ATyZEmofJmWTFHaP&si=pVYeC8SzeClLWb9V)
...
![Overall Impressions After the Course](/feedback/figures/sum24/overall_impressions.png)
...
### Now I...
![Now I...](/feedback/figures/sum24/now_i.png)
...
![Feedback After Interactions](/feedback/figures/sum24/how_do_you_feel.png)
...
![Elective Comparison](/feedback/figures/sum24/this_elective.png)
...
![Group Photo](/assets/images/group_photo_sum24.png)