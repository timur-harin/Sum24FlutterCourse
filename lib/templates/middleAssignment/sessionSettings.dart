...
class Sessionsettings extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
        backgroundColor: Color.fromARGB(255, 175, 208, 241),
        appBar: AppBar(
          backgroundColor: const Color.fromARGB(255, 175, 208, 241),
          centerTitle: true,
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                  fillColor: Color.fromRGBO(27, 122, 230, 1),
                  filled: true,
            ...
            TextButton(
              ...
              style: const ButtonStyle(
                  backgroundColor:
                      WidgetStatePropertyAll(Color.fromRGBO(27, 122, 230, 1)),
